...
const Home = () => {
  return (
    ...
    <section className='container bg-gray-400 p-4 rounded-1'>
        ...
        <div className='row d-flex justify-content-around pb-4 pt-5'>
          <div className='col-12 col-md-3 bg-dark text-light d-flex flex-column align-items-center rounded-3 p-3 mb-5 mb-md-0'>
